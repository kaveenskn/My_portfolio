...
export default function ContactSection() {
  ...
  return (
    <div className="w-full flex flex-col">
      {/* Title Header */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 mb-12 md:mb-16 flex flex-col items-center justify-center">
        <div className="flex flex-row items-center justify-center gap-5 md:gap-10 relative z-20">
          ...
          >
            Contact <span className={`text-transparent bg-clip-text bg-gradient-to-r ${isLight ? "from-cyan-600 to-blue-800" : "from-cyan-400 to-blue-600"
              }`}>Me</span>
          </motion.h2>
        </div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 w-full flex flex-col-reverse lg:flex-row-reverse items-center justify-center gap-12 lg:gap-24">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center perspective-1000 h-[400px] md:h-[500px] lg:h-[580px] relative">
          ...
          <motion.div
            ...
            className={`relative w-[260px] md:w-[280px] h-[520px] md:h-[580px] rounded-[48px] border-[14px] preserve-3d shadow-2xl ${isLight ? "bg-white border-gray-200 shadow-gray-300" : "bg-[#0a0a0a] border-[#1a1a1a] shadow-cyan-900/20"
              }`}
          >
            {/* Phone Screen Glow & Interface */}
            <div className={`absolute inset-0 rounded-[34px] overflow-hidden flex flex-col items-center justify-center ${isLight ? "bg-gradient-to-br from-cyan-50 to-white" : "bg-gradient-to-br from-[#111] to-[#050505]"
              }`}>
              ...
              <motion.div
                ...
                className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[150%] blur-[50px] ${isLight ? "bg-cyan-400/40" : "bg-cyan-600/50"
                  }`}
              />
            ...
            {popIcons.map((item, idx) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-3 md:p-4 rounded-2xl shadow-2xl backdrop-blur-md border cursor-pointer hover:shadow-[0_20px_60px_rgba(0,0,0,0.4)] transition-all ${isLight ? "bg-white/90 border-white shadow-black/10" : "bg-white/10 border-white/30 shadow-black/50 hover:bg-white/20"
                  } ${item.color}`}
              >
                <motion.div
                  animate={{ y: [-5, 5, -5] }}
        ...
        <div className="w-full lg:w-1/2 max-w-[420px] relative z-10 flex flex-col justify-center">
          <motion.div
            ...
            className={`p-8 md:p-10 rounded-[36px] border relative overflow-hidden transition-all duration-500 ${isLight
          ...
          >
            <div className="mb-8">
              <h2 className={`text-4xl md:text-5xl font-black mb-2 tracking-tighter ${isLight ? "text-gray-900" : "text-white"
                }`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  className={`w-full px-5 py-4 rounded-xl border bg-transparent outline-none transition-all text-sm font-medium ${isLight
              ...
              <div>
                <textarea
                  ...
                  className={`w-full px-5 py-4 rounded-xl border bg-transparent outline-none transition-all resize-none text-sm font-medium ${isLight
                    ? "border-black/5 focus:border-cyan-500 hover:bg-black/5 focus:bg-white text-black placeholder:text-gray-400"
                    : "border-white/5 focus:border-cyan-500 hover:bg-white/5 focus:bg-[#111] text-white placeholder:text-gray-500"
                    }`}
              ...
              <button
                ...
                className={`w-full py-4 mt-2 rounded-xl font-bold uppercase tracking-widest text-[11px] flex items-center justify-center gap-2 transition-all shadow-lg ${isLight
